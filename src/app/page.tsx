    ...
    <div className="flex flex-col min-h-screen bg-zinc-950 text-zinc-100">
      ...
      <main className="flex-1 max-w-5xl mx-auto w-full px-6 py-12 flex flex-col justify-center">
        <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full border border-indigo-500/20 bg-indigo-500/10 text-indigo-400 text-xs font-medium w-fit mb-6">
          ...
          Milestone 4 — Official Data Foundation Ready
        </div>
        ...
        <p className="text-lg text-zinc-400 max-w-2xl mb-8 leading-relaxed">
          Not a static chatbot. InterviewOS evaluates candidate learning history, constructs dynamic skill hypotheses, adapts live question difficulty, and generates evidence-backed technical reports.
        </p>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-12">
          ...
          <div className="p-5 rounded-xl border border-zinc-800 bg-zinc-900/50">
            ...
            <h3 className="font-semibold text-sm text-zinc-200 mb-1">Deterministic Reliability</h3>
            <p className="text-xs text-zinc-400">Strict Zod schema validation & fallback guardrails for complete API reliability.</p>
          </div>
        </div>
        ...
        <div className="p-6 rounded-xl border border-zinc-800/80 bg-zinc-900/30 flex flex-col md:flex-row items-start md:items-center justify-between gap-4">
          <div>
            <h2 className="text-sm font-semibold text-zinc-200">Data Access Verification Endpoint</h2>
            <p className="text-xs text-zinc-400 mt-0.5">Inspect normalized curriculum topics, candidate profiles, and validation logs.</p>
          </div>
          <Link
            href="/api/debug/data"
